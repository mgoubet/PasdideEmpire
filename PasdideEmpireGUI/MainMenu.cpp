...
MainMenu::MenuResult MainMenu::HandleClick(int x, int y)
{
	...
	{
		sf::Rect<int> l_menuItemRect = (*it).rect;
		if (l_menuItemRect.height + l_menuItemRect.top > y
			&& l_menuItemRect.top < y
			&& l_menuItemRect.left < x
			&& l_menuItemRect.width + l_menuItemRect.left> x)
		{
			return (*it).action;
		}
	}
